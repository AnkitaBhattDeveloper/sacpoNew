...
public class SDownCFormA extends BaseAPCPrivate {
    private String ActivityId="127";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stipend_id = activeInputUri.getString("stipend_id20");
    ...
    protected void verifyVersion() {
        ...
        if (isUpdate == true) {
            Intent intent = new Intent(SDownCFormA.this, AppUpdatedA.class);
...
//            callFooter(baseApcContext,activityIn,ActivityId);
    ...
    protected void initializeLabels() {
        ...
        String   Label = getLabelFromDb("b_127_btnDownloadLeadEmployerSignedForm", R.string.b_127_btnDownloadLeadEmployerSignedForm);
        btnDownloadSignedForm.setText(Label);

        Label = getLabelFromDb("b_lbl_127_form_instruction", R.string.b_lbl_127_form_instruction);
        lblInstruction.setText(Label);

        Label = getLabelFromDb("b_lbl_127_Btutton", R.string.b_lbl_127_Btutton);
        lblButton.setText(Label);

        Label = getLabelFromDb("h_127",R.string.h_127);
    ...
    protected void setLayoutXml() {
        setContentView(R.layout.a_download_claim_form);
    }
    ...
    private void getFormDetails() {
        ...
        printLogs(LogTag,"getClaimFormDetails","URL : "+FINAL_URL);
        printLogs(LogTag,"getFormDetails","Sssssstipend_id : "+stipend_id);
...
*/
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SDownCFormA.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(SDownCFormA.this, SPastClaimDA.class);
