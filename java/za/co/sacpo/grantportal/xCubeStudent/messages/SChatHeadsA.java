...
import za.co.sacpo.grantportal.xCubeLib.adapter.SChatAdapter;
import za.co.sacpo.grantportal.xCubeLib.baseFramework.BaseAPCPrivate;
import za.co.sacpo.grantportal.xCubeLib.dataObj.SChatObj;
...
public class SChatHeadsA extends BaseAPCPrivate {
    private String ActivityId="S141";
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(SChatHeadsA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        printLogs(LogTag,"setLayoutXml","a_chat_heads");
        setContentView(R.layout.a_chat_heads);
    }
    @Override
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new SChatAdapter(rDataObjList,baseApcContext,activityIn));
    }

    public void showList(){
        printLogs(LogTag,"showList","init");
        List<SChatObj.Item> AttData = rDataObj.getITEMS();
        SChatAdapter adapter = new SChatAdapter(AttData,baseApcContext,activityIn);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(SChatHeadsA.this, SChatListDA.class);
            printLogs(LogTag, "onOptionsItemSelected", "SChatListDA" + generator);
            startActivity(intent);
            finish();
        }else {
