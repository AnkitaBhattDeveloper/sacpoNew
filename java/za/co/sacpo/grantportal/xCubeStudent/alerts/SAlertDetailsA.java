...
public class SAlertDetailsA extends BaseAPCPrivate {
    private String ActivityId="208";
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(SAlertDetailsA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        printLogs(LogTag,"setLayoutXml","a_notification_details");
        setContentView(R.layout.a_notification_details);
    }
    @Override
    ...
    protected void initializeLabels(){
        ...
        String Label = getLabelFromDb("h_208",R.string.h_208);
    ...
    public void readData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,FINAL_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String sMessage = getLabelFromDb("error_110_105",R.string.error_110_105);
                    String sButtonLabelClose="Close";
                    ErrorDialog.showErrorDialog(baseApcContext,activityIn,sTitle,sMessage,sButtonLabelClose);
                }
            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        String sMessage = getLabelFromDb("error_110_106",R.string.error_110_106);
                        String sButtonLabelClose="Close";
                        ErrorDialog.showErrorDialog(baseApcContext,activityIn,sTitle,sMessage,sButtonLabelClose);
                    }
                }) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SAlertDetailsA.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            if(generator.equals("157")){
                Intent intent = new Intent(SAlertDetailsA.this,SAlertsA.class);
