package za.co.sacpo.grantportal.xCubeMentor.messages;
...
import za.co.sacpo.grantportal.xCubeLib.adapter.MChatListAdapter;
...
public class MChatListA extends MentorBaseDrawerA{
    ...
    public MChatListObj rDataObj = new MChatListObj();
    private List<MChatListObj.Item> rDataObjList = null;
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(MChatListA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        ...
        setContentView(R.layout.a_m_chatlist);
    }@Override
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new MChatListAdapter(rDataObjList,baseApcContext,activityIn));
    }

    public void showList(){
        printLogs(LogTag,"showList","init");
        List<MChatListObj.Item> ChatData = rDataObj.getITEMS();
        MChatListAdapter adapter = new MChatListAdapter(ChatData,baseApcContext,activityIn);
