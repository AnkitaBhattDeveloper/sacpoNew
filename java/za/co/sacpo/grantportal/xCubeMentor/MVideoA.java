...
public class MVideoA extends BaseAPCPrivate {
    ...
    protected void verifyVersion() {
        ...
        if (isUpdate) {
            Intent intent = new Intent(MVideoA.this, AppUpdatedA.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(MVideoA.this, MDashboardDA.class);
