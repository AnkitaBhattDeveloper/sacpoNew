...
public class LocationUpdatesService extends Service {
  ...
  //  private static final String TAG = "resPOINT";
    ...
    private static final Uri CUSTOM_SOUND = null;
    ...
    private Notification getNotification() {
      ...
      //  PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
             //   new Intent(this, SignInA.class), 0);
        ...
        // mNotificationManager.notify(builder);
    ...
    private void SavetoServer(){
        ...
        //BaseAPCPrivate.syncLocation(baseApcContext, activityIn , currentLat ,currentLong);
    }
}
