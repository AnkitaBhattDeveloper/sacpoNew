...
import za.co.sacpo.grantportal.xCubeLib.component.CropCircleTransformation;
...
public class SChatAdapter extends RecyclerView.Adapter<SChatAdapter.AttHolder> {
    private List<SChatObj.Item> aObjList;
    private String CAId;
    private Context baseActivityContext;
    private AppCompatActivity activityInCall;
    //Todo: Table Width Problem
    public SChatAdapter(List<SChatObj.Item > aObjList, Context baseActivityContext, AppCompatActivity activityInCall) {
