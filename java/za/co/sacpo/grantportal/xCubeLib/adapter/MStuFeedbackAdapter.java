...
import za.co.sacpo.grantportal.xCubeLib.dataObj.StuFeedbackObj;
import za.co.sacpo.grantportal.xCubeLib.db.DbHelper;
import za.co.sacpo.grantportal.xCubeMentor.notes.MAddNote;
import za.co.sacpo.grantportal.xCubeMentor.notes.MNoteList;
import za.co.sacpo.grantportal.xCubeMentor.feedback.MStudentReports;
import za.co.sacpo.grantportal.xCubeMentor.feedback.MFeedbackA;

public class MStuFeedbackAdapter extends RecyclerView.Adapter<MStuFeedbackAdapter.ViewHolder> implements BaseAdapter {
    ...
    public MStuFeedbackAdapter(List<StuFeedbackObj.Item > aObjList, Context baseActivityContext, AppCompatActivity activityInCall) {
    ...
    @Override
    public MStuFeedbackAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.m_student_feedback_row, parent, false);
        return new MStuFeedbackAdapter.ViewHolder(itemView);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(final MStuFeedbackAdapter.ViewHolder holder, final int position) {
        ...
        if (position == 0) {
            ...
            holder.TxtReportsCounts.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    inputUri.putString("student_name", holder.hItem.msfLearnerName3);
                    inputUri.putString("generator", "335");
...
*/
        ...
        holder.TxtLearnerName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String sToolTip = aObjList.get(holder.getAdapterPosition()).msfLearnerName3;
                ((BaseAPC) activityInCall).showTooltip(holder.TxtLearnerName, sToolTip, 4);
            }
        });
