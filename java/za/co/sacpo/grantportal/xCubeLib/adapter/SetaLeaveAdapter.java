...
import za.co.sacpo.grantportal.xCubeLib.dataObj.GMAttObj;
import za.co.sacpo.grantportal.xCubeLib.db.DbHelper;

public class SetaLeaveAdapter extends RecyclerView.Adapter<SetaLeaveAdapter.ViewHolder> {
    private List<GMAttObj.Item> aObjList;
    private String CAId;
    ...
    String Labels;
    String temp;
    public SetaLeaveAdapter(List<GMAttObj.Item > aObjList, Context baseActivityContext, AppCompatActivity activityInCall) {
    ...
    @Override
    public SetaLeaveAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.seta_leve__att_layout, parent, false);
        return new SetaLeaveAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final SetaLeaveAdapter.ViewHolder holder, final int position) {
