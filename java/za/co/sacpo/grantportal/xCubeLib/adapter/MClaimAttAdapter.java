...
import za.co.sacpo.grantportal.xCubeLib.dataObj.MClaimAttObj;
import za.co.sacpo.grantportal.xCubeLib.db.DbHelper;

public class MClaimAttAdapter extends RecyclerView.Adapter<MClaimAttAdapter.ViewHolder> {
    private List<MClaimAttObj.Item> aObjList;
    private String CAId;
    ...
    String Labels;
    String temp;
    public MClaimAttAdapter(List<MClaimAttObj.Item > aObjList, Context baseActivityContext, AppCompatActivity activityInCall) {
    ...
    @Override
    public MClaimAttAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_claimattlist,parent, false);
        return new MClaimAttAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final MClaimAttAdapter.ViewHolder holder, final int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public MClaimAttObj.Item hItem;
