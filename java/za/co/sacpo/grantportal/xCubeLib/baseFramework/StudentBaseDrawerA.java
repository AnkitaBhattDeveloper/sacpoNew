...
import za.co.sacpo.grantportal.xCubeLib.db.DashboardDataArrayAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.GrantDetailsArrayAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.attDetailsArrayAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.attListDetailsAdapter;
...
import za.co.sacpo.grantportal.xCubeLib.db.existingLeaveListAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.pastClaimListAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.populateAttListAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.sWeeklyReportDetailsAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.sWeeklyReportListAdapter;
import za.co.sacpo.grantportal.xCubeLib.db.supervisorDetailsAdapter;
import za.co.sacpo.grantportal.xCubeLib.session.OlumsGrantSession;
import za.co.sacpo.grantportal.xCubeStudent.editprofile.SEditProfileMainA;
import za.co.sacpo.grantportal.xCubeStudent.SDashboardDA;
import za.co.sacpo.grantportal.xCubeStudent.SUploadPicA;
import za.co.sacpo.grantportal.xCubeStudent.attendance.SAttDA;
import za.co.sacpo.grantportal.xCubeStudent.attendance.SOutOfRangeA;
import za.co.sacpo.grantportal.xCubeStudent.bank.SBankDA;
import za.co.sacpo.grantportal.xCubeStudent.feedback.SLearnerReportsList;
import za.co.sacpo.grantportal.xCubeStudent.forms.SFormsA;
...
import za.co.sacpo.grantportal.xCubeStudent.queries.SQueriesGroupA;
import za.co.sacpo.grantportal.xCubeStudent.stipends.SStipendsDA;
