...
public class MLearnerAbsentObj {
    public List<MLearnerAbsentObj.Item> ITEMS = new ArrayList<MLearnerAbsentObj.Item>();
    public Map<Integer, MLearnerAbsentObj.Item> ITEM_MAP = new HashMap<>();
    public void addItem(MLearnerAbsentObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<MLearnerAbsentObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, MLearnerAbsentObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public MLearnerAbsentObj.Item createItem(int pos1, int aId2, String FMaDate3, String FMaDay4, String FMaLoginTime5, String FMaLogoutTime6, String FMaHoursWorked7,
                                             String FMaLearnerComment8, String FMaAttStatus9) {
        return new MLearnerAbsentObj.Item(String.valueOf(pos1),aId2,FMaDate3,FMaDay4,FMaLoginTime5,FMaLogoutTime6,FMaHoursWorked7,FMaLearnerComment8,FMaAttStatus9);
    }
