...
public class SMLearnerClaimObj {


    public List<SMLearnerClaimObj.Item> ITEMS = new ArrayList<SMLearnerClaimObj.Item>();
    public Map<String, SMLearnerClaimObj.Item> ITEM_MAP = new HashMap<String, SMLearnerClaimObj.Item>();
    public void addItem(SMLearnerClaimObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<SMLearnerClaimObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<String, SMLearnerClaimObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public SMLearnerClaimObj.Item createItem(int pos1, String aId2, String claDate3, String claMonth4, String cla_ammount5, String dayswork6,
                                           String leavecount7, String absentcount8, String m_status9, String m_date10,
                                           String m_ammount_status11, String admin_approve_ammount12, String admin_approve_date13, String sm_student_id14
            ,String claGrantId15,String claStatus16, String present_type17, String leave_type18, String absent_type19, String month20,String year21){


        return new SMLearnerClaimObj.Item(String.valueOf(pos1),aId2,claDate3,claMonth4,cla_ammount5,dayswork6,
                leavecount7,absentcount8,m_status9,m_date10,m_ammount_status11,admin_approve_ammount12,admin_approve_date13,sm_student_id14 ,claGrantId15,claStatus16 ,present_type17,leave_type18,absent_type19,month20 ,year21);
    }
    ...
    public static class Item {
        ...
        public final String sm_student_id14;
        ...
        public Item(String aPos1, String aId2, String claDate3, String claMonth4, String cla_ammount5,
                    ...
                    String m_date10, String m_ammount_status11, String admin_approve_ammount12, String admin_approve_date13, String sm_student_id14,
                    String claGrantId15, String claStatus16 , String present_type17 , String leave_type18
            ...
            this.sm_student_id14=sm_student_id14;
