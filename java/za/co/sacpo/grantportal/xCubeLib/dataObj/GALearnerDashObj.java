...
public class GALearnerDashObj {

    public List<GALearnerDashObj.Item> ITEMS = new ArrayList<GALearnerDashObj.Item>();
    public Map<Integer, GALearnerDashObj.Item> ITEM_MAP = new HashMap<Integer, GALearnerDashObj.Item>();
    public void addItem(GALearnerDashObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<GALearnerDashObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, GALearnerDashObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public GALearnerDashObj.Item createItem(int pos1, int aId2,String PrReport3,
         ...
         String g_sdl_no10,String gsupervisor_name11,String gDuration12,String gSDate13
          ...
          ,String g_student_id18,String g_stipend_id_19,String mentor_id20) {
        return new GALearnerDashObj.Item(String.valueOf(pos1),aId2,PrReport3,
    ...
    public static class Item {
        ...
        public Item(String aPos1, int aId2, String PrReport3, String g_learner_name4, String g_learner_status5, String g_learnerEmail6, String gLearId7, String gCurrentStatus8, String g_emp_name9,
                ...
                ,String gDuration12,String gSDate13,String gEDate14,String g_setaAllocation15,String gclaimed16,String g_unspent17,String g_student_id18,String g_stipend_id_19,String mentor_id20) {
            this.aPos1 = aPos1;
            this.aId2 = aId2;
