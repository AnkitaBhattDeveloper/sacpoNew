...
public class MClaimAttObj {
    public List<MClaimAttObj.Item> ITEMS = new ArrayList<MClaimAttObj.Item>();
    public Map<Integer, MClaimAttObj.Item> ITEM_MAP = new HashMap<>();
    public void addItem(MClaimAttObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<MClaimAttObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, MClaimAttObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public MClaimAttObj.Item createItem(int pos1, int aId2, String FMaDate3, String FMaDay4, String FMaLoginTime5, String FMaLogoutTime6, String FMaHoursWorked7,
                                        String FMaLearnerComment8, String FMaAttStatus9) {
        return new MClaimAttObj.Item(String.valueOf(pos1),aId2,FMaDate3,FMaDay4,FMaLoginTime5,FMaLogoutTime6,FMaHoursWorked7,FMaLearnerComment8,FMaAttStatus9);
    }
