...
public class GMLeaveObj {
    public List<GMLeaveObj.Item> ITEMS = new ArrayList<GMLeaveObj.Item>();
    public Map<Integer, GMLeaveObj.Item> ITEM_MAP = new HashMap<>();
    public void addItem(GMLeaveObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<GMLeaveObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, GMLeaveObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public GMLeaveObj.Item createItem(int pos1, int aId2, String FMaDate3, String FMaDay4, String FMaLoginTime5, String FMaLogoutTime6, String FMaHoursWorked7,
                                    String FMaLearnerComment8, String FMaAttStatus9) {
        return new GMLeaveObj.Item(String.valueOf(pos1),aId2,FMaDate3,FMaDay4,FMaLoginTime5,FMaLogoutTime6,FMaHoursWorked7,FMaLearnerComment8,FMaAttStatus9);
    }
