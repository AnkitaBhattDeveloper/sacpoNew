...
public class DashboardDataArrayAdapter implements DashboardDataArrayDAO{
    ...
    public long insert(DashboardDataArray dataArrays) {
        ...
        contentValues.put(DbSchema.COLUMN_STUDENT_ID,dataArrays.getS_s_g_student_id());
    ...
    public int update(DashboardDataArray dataArrays) {
        ...
        int data = db.update(DbSchema.TABLE_DASHBOARD_DATA, contentValues, DbSchema.COLUMN_STUDENT_ID + " = " + dataArrays.getS_s_g_student_id(), null);
        //db.close();
        return data;
    }
    ...
    public int delete(int id) {
        ...
        SQLiteDatabase db = databaseHelper.getWritableDatabase();
        int data = db.delete(DbSchema.TABLE_DASHBOARD_DATA, DbSchema.COLUMN_STUDENT_ID + " = " + id, null);
        //db.close();
        return data;
    }
    ...
    public DashboardDataArray getById(int id) {
        ...
        String[] columns = { DbSchema.COLUMN_STUDENT_ID,DbSchema.COLUMN_GRANT_ID ,DbSchema.COLUMN_LEARNER_NAME ,
        ...
        Cursor cursors = db.query(DbSchema.TABLE_DASHBOARD_DATA, columns, DbSchema.COLUMN_STUDENT_ID + " = " + id, null, null, null, null);

        try {
            if (cursors.moveToNext()) {
                String s_s_g_student_id = cursors.getString(cursors.getColumnIndex(DbSchema.COLUMN_STUDENT_ID));
    ...
    public List<DashboardDataArray> getAll() {
        ...
        List<DashboardDataArray> dataArrayList = new ArrayList<>();
     //   DashboardDataArray dataArray = null;
        SQLiteDatabase db = databaseHelper.getWritableDatabase();
        ...
        String[] columns = {DbSchema.COLUMN_STUDENT_ID, DbSchema.COLUMN_GRANT_ID, DbSchema.COLUMN_LEARNER_NAME,
                ...
                DbSchema.COLUMN_WORKSTATION_BTN, DbSchema.COLUMN_DEPT_NAME, DbSchema.COLUMN_COMPLETED_REPORTCOUNT,
                DbSchema.COLUMN_REPORTOVERDUE_COUNT, DbSchema.COLUMN_TRAINING_PROGRAM, DbSchema.COLUMN_TRAINING_PROGRAM_STATUS};
        Cursor cursors = db.query(DbSchema.TABLE_DASHBOARD_DATA, columns, null, null, null, null, null);
        ...
        try {
            if (cursors.moveToNext()) {
                ...
                DashboardDataArray dataArray = new DashboardDataArray(s_s_g_student_id, grant_id, learner_name, learner_status, startDate, end_Date,
                        bankName, show_add_bank_btn, seta_ame, managedBy, employer_name, supervisor_name,
                        attStatus, s_s_g_is_edit_attendance, show_attendance_link, show_attendance_color, atendance_status,
                        view_attendance_link, pastmonthCount, current_claim_status, claim_color, past_claim_btn,
                        workstation_btn, deptName, completed_report_count, reportOverDue_count, training_program,
