package za.co.sacpo.grant.xCubeMentor.alerts;
...
import za.co.sacpo.grant.xCubeLib.adapter.NAdapter;
...
public class MAlertsA extends BaseAPCPrivate {
    private String ActivityId="324";
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(MAlertsA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        printLogs(LogTag,"setLayoutXml","a_m_notifications");
        setContentView(R.layout.a_m_notifications);
    }
    @Override
    protected void initializeViews() {
        ...
        View recyclerView = findViewById(R.id.rVN);
    ...
    protected void initializeLabels(){
        ...
        String Label = getLabelFromDb("h_324",R.string.h_324);
    ...
    public void fetchData(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MAlertsA.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            if(generator.equals("115")){
                Intent intent = new Intent(MAlertsA.this,MAlertsGroupA.class);
