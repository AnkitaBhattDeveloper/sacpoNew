package za.co.sacpo.grant.xCubeMentor.announcement;
...
import za.co.sacpo.grant.xCubeLib.adapter.FMAnnounceAdapter;
import za.co.sacpo.grant.xCubeLib.baseFramework.BaseAPCPrivate;
import za.co.sacpo.grant.xCubeLib.component.URLHelper;
import za.co.sacpo.grant.xCubeLib.component.Utils;
import za.co.sacpo.grant.xCubeLib.dataObj.FMAnnounceObj;
...
public class MAnnouncement extends BaseAPCPrivate {
    ...
    public FMAnnounceObj rDataObj = new FMAnnounceObj();
    private MAnnouncement thisClass;
    private List<FMAnnounceObj.Item> rDataObjList = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        printLogs(LogTag,"onCreate","GROUP ID "+student_id);
        bootStrapInit();
    }
    @Override
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(MAnnouncement.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        ...
        setContentView(R.layout.a_m_announcement);
    }
    @Override
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new FMAnnounceAdapter(rDataObjList,baseApcContext,activityIn,ActivityId,this));
    }
    public void showList(){
        printLogs(LogTag,"showList","init");
        List<FMAnnounceObj.Item> NGData = rDataObj.getITEMS();
        Collections.reverse(NGData);
        FMAnnounceAdapter adapter = new FMAnnounceAdapter(NGData,baseApcContext,activityIn,ActivityId,this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
                Intent intent = new Intent(MAnnouncement.this,MDashboardDA.class);
