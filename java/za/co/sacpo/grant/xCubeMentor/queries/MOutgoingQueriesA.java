...
import za.co.sacpo.grant.xCubeLib.adapter.TAdapter;
...
public class MOutgoingQueriesA extends BaseAPCPrivate {
    private String ActivityId="111";
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(MOutgoingQueriesA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        printLogs(LogTag,"setLayoutXml","a_tickets");
        setContentView(R.layout.a_m_tickets);
    }
    @Override
                ...
                try {
                    ...
                    if(Status.equals("1")){
                        ...
                        for (int i = 0; i < dataM.length(); i++) {
                            ...
                            String aTTitle3 = rec.getString("title");
                            String aTRef4 = rec.getString("i_reference_no");
                            String aTDate5 = rec.getString("i_date");
                            String aTStatusText6 = rec.getString("status");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(MOutgoingQueriesA.this,MQueriesGroupA.class);
