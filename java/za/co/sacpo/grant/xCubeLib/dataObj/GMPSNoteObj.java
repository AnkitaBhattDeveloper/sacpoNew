...
public class GMPSNoteObj {
    public List<GMPSNoteObj.Item> ITEMS = new ArrayList<GMPSNoteObj.Item>();
    public Map<Integer, GMPSNoteObj.Item> ITEM_MAP = new HashMap<Integer, GMPSNoteObj.Item>();
    public void addItem(GMPSNoteObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<GMPSNoteObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, GMPSNoteObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;

    }
    public GMPSNoteObj.Item createItem(int pos1, int aId2, String description3, String add_date4,
                                       String  addby5, String  note_for6, String  cell_no7, String  note_from8, String  duration9, String  note_10) {

        return new GMPSNoteObj.Item(String.valueOf(pos1),aId2,description3,add_date4,addby5,note_for6,cell_no7,note_from8,duration9,note_10);
    }
