...
public class GMPSClaimObj {
    ...
    public Item createItem(int pos1,int aId2,String GMNotes3,String GMLearnerName4,String GMPNumber5,String GMLearnerNumber6,
                           String GMLearnerId7, String GMClaimDate8, String GMClaimAmount9, String GMDaysWorked10,
                           String GMLeave11, String GMStipend_schedule_id12,String GMRegNo13) {

        return new Item(String.valueOf(pos1),aId2,GMNotes3,GMLearnerName4,GMPNumber5,GMLearnerNumber6,GMLearnerId7,GMClaimDate8,
                GMClaimAmount9,GMDaysWorked10,GMLeave11,GMStipend_schedule_id12,GMRegNo13);
    }
    ...
    public static class Item {
        ...
        public final String GMStipend_schedule_id12;
        ...
        public Item(String aPos1, int aId2, String GMNotes3, String GMLearnerName4, String GMPNumber5, String GMLearnerNumber6,
                    ...
                    String GMStipend_schedule_id12,String GMRegNo13) {
            ...
            this.GMStipend_schedule_id12 = GMStipend_schedule_id12;
