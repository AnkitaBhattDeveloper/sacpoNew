...
public class SVPSNoteObj {
    public List<SVPSNoteObj.Item> ITEMS = new ArrayList<SVPSNoteObj.Item>();
    public Map<Integer, SVPSNoteObj.Item> ITEM_MAP = new HashMap<Integer, SVPSNoteObj.Item>();
    public void addItem(SVPSNoteObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<SVPSNoteObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, SVPSNoteObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;

    }
    public SVPSNoteObj.Item createItem(int pos1, int aId2, String description3, String add_date4,
                                       String  addby5, String  note_for6, String  cell_no7, String  note_from8, String  duration9, String  note_10) {

        return new SVPSNoteObj.Item(String.valueOf(pos1),aId2,description3,add_date4,addby5,note_for6,cell_no7,note_from8,duration9,note_10);
    }
