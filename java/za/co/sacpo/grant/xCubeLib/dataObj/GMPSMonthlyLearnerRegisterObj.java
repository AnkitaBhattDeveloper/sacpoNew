...
public class GMPSMonthlyLearnerRegisterObj {
    public List<GMPSMonthlyLearnerRegisterObj.Item> ITEMS = new ArrayList<GMPSMonthlyLearnerRegisterObj.Item>();
    public Map<Integer, GMPSMonthlyLearnerRegisterObj.Item> ITEM_MAP = new HashMap<>();
    public void addItem(GMPSMonthlyLearnerRegisterObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<GMPSMonthlyLearnerRegisterObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, GMPSMonthlyLearnerRegisterObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public GMPSMonthlyLearnerRegisterObj.Item createItem(int pos1, int aId2, String FMaDate3, String FMaDay4, String FMaLoginTime5, String FMaLogoutTime6, String FMaHoursWorked7,
                                                         String FMaLearnerComment8, String FMaAttStatus9,String FMaAttSupervisorStatus10, String FMaGrantAdminAttStatus11) {
        return new GMPSMonthlyLearnerRegisterObj.Item(String.valueOf(pos1),aId2,FMaDate3,FMaDay4,FMaLoginTime5,FMaLogoutTime6,
