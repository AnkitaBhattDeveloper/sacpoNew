...
public class MClaimLeaveObj {
    public List<MClaimLeaveObj.Item> ITEMS = new ArrayList<MClaimLeaveObj.Item>();
    public Map<Integer, MClaimLeaveObj.Item> ITEM_MAP = new HashMap<>();
    public void addItem(MClaimLeaveObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<MClaimLeaveObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, MClaimLeaveObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public MClaimLeaveObj.Item createItem(int pos1, int aId2, String FMaDate3, String FMaDay4, String FMaLoginTime5, String FMaLogoutTime6, String FMaHoursWorked7,
                                          String FMaLearnerComment8, String FMaAttStatus9) {
        return new MClaimLeaveObj.Item(String.valueOf(pos1),aId2,FMaDate3,FMaDay4,FMaLoginTime5,FMaLogoutTime6,FMaHoursWorked7,FMaLearnerComment8,FMaAttStatus9);
    }
