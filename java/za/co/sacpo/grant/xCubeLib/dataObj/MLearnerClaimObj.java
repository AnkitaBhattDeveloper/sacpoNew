...
public class MLearnerClaimObj {


    public List<MLearnerClaimObj.Item> ITEMS = new ArrayList<MLearnerClaimObj.Item>();
    public Map<String, MLearnerClaimObj.Item> ITEM_MAP = new HashMap<String, MLearnerClaimObj.Item>();
    public void addItem(MLearnerClaimObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<MLearnerClaimObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<String, MLearnerClaimObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public MLearnerClaimObj.Item createItem(int pos1, String aId2, String claDate3, String claMonth4, String cla_ammount5, String dayswork6,
        ...
        return new MLearnerClaimObj.Item(String.valueOf(pos1),aId2,claDate3,claMonth4,cla_ammount5,dayswork6,
