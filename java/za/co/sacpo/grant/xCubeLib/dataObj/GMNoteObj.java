...
public class GMNoteObj {
    public List<GMNoteObj.Item> ITEMS = new ArrayList<GMNoteObj.Item>();
    public Map<Integer, GMNoteObj.Item> ITEM_MAP = new HashMap<Integer, GMNoteObj.Item>();
    public void addItem(GMNoteObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<GMNoteObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer,GMNoteObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;

    }
    public GMNoteObj.Item createItem(int pos1, int aId2, String description3, String add_date4,
                                     String  addby5, String  note_for6, String  cell_no7, String  note_from8, String  duration9, String  note_10) {

        return new GMNoteObj.Item(String.valueOf(pos1),aId2,description3,add_date4,addby5,note_for6,cell_no7,note_from8,duration9,note_10);
    }
