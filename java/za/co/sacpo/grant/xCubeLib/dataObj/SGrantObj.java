...
public class SGrantObj {
    ...
    public Item createItem(int pos1,int aId2,String aLiDate3,String aLiTime4,String aLoDate5, String aLoTime6,String aTimeSpent7,String aStatus8,String aDay9) {
        return new Item(String.valueOf(pos1),aId2,aLiDate3,aLiTime4,aLoDate5,aLoTime6,aTimeSpent7,aStatus8,aDay9);
    }
    ...
    public static class Item {
        ...
        public Item(String aPos1,int aId2, String aLiDate3, String aLiTime4,String aLoDate5,String aLoTime6,String aTimeSpent7,String aStatus8,String aDay9) {
            this.aId2 = aId2;
            this.aPos1 = aPos1;
