...
public class SVLearnerListObj {

    public List<SVLearnerListObj.Item> ITEMS = new ArrayList<SVLearnerListObj.Item>();
    public Map<Integer, SVLearnerListObj.Item> ITEM_MAP = new HashMap<Integer, SVLearnerListObj.Item>();
    public void addItem(SVLearnerListObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<SVLearnerListObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, SVLearnerListObj.Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public SVLearnerListObj.Item createItem(int pos1, int aId2, String PrReport3,
        ...
        return new SVLearnerListObj.Item(String.valueOf(pos1),aId2,PrReport3,
