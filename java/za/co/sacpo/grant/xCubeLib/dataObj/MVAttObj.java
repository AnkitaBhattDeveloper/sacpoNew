...
public class MVAttObj {

    public List<MVAttObj.Item> ITEMS = new ArrayList<MVAttObj.Item>();
    public Map<Integer, MVAttObj.Item> ITEM_MAP = new HashMap<>();
    public void addItem(MVAttObj.Item item) {
        this.ITEMS.add(item);
        this.ITEM_MAP.put(item.aId2, item);
    }
    public List<MVAttObj.Item> getITEMS(){
        return this.ITEMS;
    }
    public Map<Integer, Item> getITEM_MAP(){
        return this.ITEM_MAP;
    }
    public MVAttObj.Item createItem(int pos1, int aId2, String mVADate3, String mVADay4, String mVATime5
            , String lblLogoutTime6, String lblLoginTime7, String mcord_diff8, String attt_id9, String approval_status10, String remark11) {
        return new MVAttObj.Item(String.valueOf(pos1),aId2,mVADate3
