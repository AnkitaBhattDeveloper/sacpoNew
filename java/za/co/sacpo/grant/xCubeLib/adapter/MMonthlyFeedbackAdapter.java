...
import za.co.sacpo.grant.xCubeLib.dataObj.MMonthlyFeedbackObj;
import za.co.sacpo.grant.xCubeLib.db.DbHelper;
import za.co.sacpo.grant.xCubeMentor.claims.MMonthlyFeedbackA;

public class MMonthlyFeedbackAdapter extends RecyclerView.Adapter<MMonthlyFeedbackAdapter.ViewHolder> {
    private List<MMonthlyFeedbackObj.Item> aObjList;
    private String CAId;
    ...
    MMonthlyFeedbackA baseActivity;

    public MMonthlyFeedbackAdapter(List<MMonthlyFeedbackObj.Item> aObjList, Context baseActivityContext, AppCompatActivity activityInCall, MMonthlyFeedbackA baseActivity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_m_monthly_feedback, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public MMonthlyFeedbackObj.Item hItem;
