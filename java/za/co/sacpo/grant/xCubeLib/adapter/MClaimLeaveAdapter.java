...
import za.co.sacpo.grant.xCubeLib.dataObj.MClaimLeaveObj;
import za.co.sacpo.grant.xCubeLib.db.DbHelper;

public class MClaimLeaveAdapter extends RecyclerView.Adapter<MClaimLeaveAdapter.ViewHolder> {
    private List<MClaimLeaveObj.Item> aObjList;
    private String CAId;
    ...
    public MClaimLeaveAdapter(List<MClaimLeaveObj.Item> aObjList, Context baseActivityContext, AppCompatActivity activityInCall) {
    ...
    @Override
    public MClaimLeaveAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_learner_leavelist, parent, false);
        return new MClaimLeaveAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final MClaimLeaveAdapter.ViewHolder holder, final int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public MClaimLeaveObj.Item hItem;
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            hView = itemView;
            tRow = (TableRow) itemView.findViewById(R.id.GM_claim_att_Row);
