...
public class SLSupervisorCommentsA extends BaseAPCPrivate {

    private String ActivityId="S117";
    //TODO :: Map Correction
  ...
  //  private GoogleMap googleMap;
    String scomments,generator,dated;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        scomments = activeInputUri.getString("scomments");
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate==true){
            Intent intent = new Intent(SLSupervisorCommentsA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        ...
        setContentView(R.layout.a_s_leave_comments);
    }
    @Override
    ...
    protected void initializeInputs(){
        ...
        txtLeave_reason.setText(scomments);
    ...
    protected void initializeLabels(){
        ...
        String  Label = getLabelFromDb("h_S117",R.string.h_S117);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(SLSupervisorCommentsA.this,SLeavesDA.class);
