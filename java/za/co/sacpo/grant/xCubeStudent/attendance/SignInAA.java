...
public class SignInAA extends BaseFormAPCPrivate implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void initializeListeners() {
        ...
        btnPunchOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                inBundle = new Bundle();
                Intent intent = new Intent(SignInAA.this, SignOutAA.class);
    ...
    private void enableLoc() {
        if (mGoogleApiClient == null) {
            mGoogleApiClient = new GoogleApiClient.Builder(SignInAA.this)
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(SignInAA.this, REQUEST_LOCATION);
    ...
    protected void verifyVersion() {
        ...
        if (isUpdate) {
            Intent intent = new Intent(SignInAA.this, AppUpdatedA.class);
            startActivity(intent);
            finish();
        }
    }
    ...
    public void customRedirector(){
        Intent intent = new Intent(SignInAA.this, SDashboardDA.class);
        ...
        if (mLastLocation != null) {
          ...
          //  submituserlatlong(latitude,longitude);
           ...
           // createMarker(latitude, longitude, "SIGN-IN", "", BitmapDescriptorFactory.HUE_AZURE);
            ...
            AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(SignInAA.this);
            ...
            alertDialog2.setNegativeButton("Refresh",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.cancel();
                            inBundle = new Bundle();
                            Intent intent = new Intent(SignInAA.this, SignInAA.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent = new Intent(SignInAA.this, SCurrentAttDA.class);
