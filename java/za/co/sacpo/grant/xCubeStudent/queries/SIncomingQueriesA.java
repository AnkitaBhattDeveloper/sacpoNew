...
public class SIncomingQueriesA extends BaseAPCPrivate {
    private String ActivityId="207";
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(SIncomingQueriesA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        setContentView(R.layout.a_admin_tickets);
    }
    ...
    protected void initializeLabels(){
        ...
        String Label = getLabelFromDb("h_207",R.string.h_207);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(SIncomingQueriesA.this,SQueriesGroupA.class);
