...
public class SOutgoingQueriesA extends BaseAPCPrivate {
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(SOutgoingQueriesA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        ...
        setContentView(R.layout.a_tickets);
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(SOutgoingQueriesA.this,SQueriesGroupA.class);
            printLogs(LogTag,"onOptionsItemSelected","SQueriesGroupA");
            startActivity(intent);
            finish();
        }
      return true;
