...
public class SQueriesGroupA extends StudentBaseDrawerA {
    private String ActivityId="402";
    ...
    protected void verifyVersion(){
        ...
        if(isUpdate){
            Intent intent = new Intent(SQueriesGroupA.this,AppUpdatedA.class);
    ...
    protected void setLayoutXml() {
        ...
        setContentView(R.layout.a_tickets_group);
    }
    @Override
    ...
    protected void initializeListeners() {
        myQueries.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SQueriesGroupA.this,SOutgoingQueriesA.class);
        ...
        adminQueries.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                outBundle = new Bundle();
                Intent intent = new Intent(SQueriesGroupA.this,SIncomingQueriesA.class);
